...
class DataException(TException):
    ...
    thrift_spec = (
        ...
        (3, TType.STRING, 'dataTime', 'UTF8', None, ),  # 3
    )

    def __init__(self, message=None, callStack=None, dataTime=None,):
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRING:
                    self.dataTime = iprot.readString().decode('utf-8') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        ...
        if self.dataTime is not None:
            oprot.writeFieldBegin('dataTime', TType.STRING, 3)
            oprot.writeString(self.dataTime.encode('utf-8') if sys.version_info[0] == 2 else self.dataTime)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
